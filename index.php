  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <div class="logo me-auto">
        <h1><a href="index.php">Scaffold</a></h1>
          ...
          <div class="col-lg-8 d-flex flex-column justify-contents-center" data-aos="fade-left">
            <div class="content pt-4 pt-lg-0">
              ...
              <table>
                ...
                <tr>
                  <td class="heading">Name</td><td>:</td><td class="text"><?php echo $val['Name'] ?></td>
                </tr>
                <tr>
                  <td class="heading">Email</td><td>:</td><td class="text"><?php echo $val['Email'] ?></td>
                </tr>
                <tr>
                  <td class="heading">Phone</td><td>:</td><td class="text"><?php echo $val['Phone'] ?></td>
                </tr>
                <tr>
                  <td class="heading">A/C number</td><td>:</td><td class="text"><?php echo $val['A/C number'] ?></td>
                </tr>
                <tr>
                 <td class="heading">Amount Earned</td><td>:</td><td class="text"><?php echo $val['Amount'] ?></td>
               </tr>
             </tbody>
              </table>
              <br><br>
      ...
      <div class="container">
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <?php
                    ...
                    {
              ?>
              <div class=" portfolio-item filter-card" id=<?php echo $val['Task_id'] ?> onclick="assignment_divert(this.id)">
            <div class="portfolio-wrap">
              <div class="topic_tabs"  >
                <h3 style="text-align: center; font-size: 18px;"><?php echo $val['Task_Title'] ?></h3>
                <p style="text-align: center;">Due: <?php echo $val['Due_Timestamp'] ?></p>
          ...
          <?php
                    ...
                    {
              ?>
              <div  class=" portfolio-item filter-web" id=<?php echo $val['Task_id'] ?> onclick="assignment_divert(this.id)">
            <div  class="portfolio-wrap">
              <div class="topic_tabs">
                <h3 style="text-align: center; font-size: 18px;"><?php echo $val['Task_Title'] ?></h3>
                <p style="text-align: center;">Due: <?php echo $val['Due_Timestamp'] ?></p>
